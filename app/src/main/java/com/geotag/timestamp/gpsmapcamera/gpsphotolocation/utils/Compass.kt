...
class Compass(context: Context) : SensorEventListener {
    ...
    var degree = MutableLiveData<Double>()
    ...
    init {
        ...
        if (gsensor == null || msensor == null) {
            // Handle the case where one or both sensors are not available on this device
            // You can display an error message or take appropriate action.
            Log.e(TAG, "Accelerometer or Magnetic Field sensor not available on this device")
        }
    }
...
//        Log.i(TAG, "will set rotation from " + currectAzimuth + " to " + azimuth)
        ...
        degree.postValue(azimuth.toDouble())
    }
