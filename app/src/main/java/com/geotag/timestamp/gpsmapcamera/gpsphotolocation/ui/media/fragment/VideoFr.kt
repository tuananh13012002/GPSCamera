...
import com.geotag.timestamp.gpsmapcamera.gpsphotolocation.databinding.FragmentVideoBinding
...
class VideoFr : AbsFragment<FragmentVideoBinding>(), DetailAdapterV2.OnListener {

    private val viewModel by viewModels<MediaViewModel>()
    override fun getLayoutRes() = R.layout.fragment_video
